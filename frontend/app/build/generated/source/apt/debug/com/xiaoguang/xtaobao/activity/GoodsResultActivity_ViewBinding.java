...
public class GoodsResultActivity_ViewBinding<T extends GoodsResultActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public GoodsResultActivity_ViewBinding(final T target, View source) {
    this.target = target;
